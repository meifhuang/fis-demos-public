...
export default function QuizPage({
  ...
  const hasCompletedQuiz = quiz.questions.every((question) =>
  ...
  return (
    <div className="max-w-5xl mx-auto font-inter min-h-screen w-full flex flex-col gap-2">
      <Pagination
        ...
        onChange={(i) => setQuestionIndex(i - 1)}
      ...
      <div className="flex flex-row justify-between mt-1">
        <Button
          ...
          onPress={() => setQuestionIndex((v) => v - 1)}
        >
          Previous
        </Button>
        {isFinalQuestion ? (
