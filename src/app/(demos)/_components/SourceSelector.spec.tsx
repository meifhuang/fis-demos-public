...
describe("SourceSelector", () => {
  ...
  it("shows custom inputs when Custom is selected", () => {
    ...
    expect(screen.getByLabelText(/custom source title/i)).toBeInTheDocument();
    expect(screen.getByLabelText(/custom source content/i)).toBeInTheDocument();
  });
